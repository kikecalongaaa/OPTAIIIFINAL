...
namespace Infra.Datos
{
    public class UsuarioDatos
    {
        ...
        {//modificar los datos de la tabla incluyendo los estados del usuario
            var conn = conexion.GetConexion();
        ...
        public void eliminarUsuario(int id)//eliminar usuario con id
        {
            var conn = conexion.GetConexion();
        ...
        {//obtenemos la persona con el id  de usuario uniendo tablas
            var conn = conexion.GetConexion();
        ...
        {//obtenemos el usuario haciendo uso del nombre de la persona 
            var conn = conexion.GetConexion();
            var comando = new Npgsql.NpgsqlCommand($"Select u.*, p.* from usuarios u " +
                                                   $" inner join persona p on u.id_per = p.id_per" +
