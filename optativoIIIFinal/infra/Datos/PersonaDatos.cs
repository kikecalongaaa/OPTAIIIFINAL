...
namespace Infra.Datos
{
    public class PersonaDatos
    {
        ...
        {
            //realizamos un Insert dentro de las columnas
        ...
        {//Update para los campos de Persona donde el Documento de la persona sea igual al solicitado
            var conn = conexion.GetConexion();
        ...
        {//eliminar persona teniendo en cuenta el docmuento 
            var conn = conexion.GetConexion();
        ...
        {
            var conn = conexion.GetConexion();//Listar persona haciendo las uniones de id ciudad con persona  usando con nro de documento
